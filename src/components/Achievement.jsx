...
function Achievement() {
  ...
  return (
    <div className="pt-[233px]">
      <h1 className="lg:w-[739px] mx-auto sm:h-[123px] text-center text-[48px] font-[900] leading-[55px] uppercase text-white">
        <span
          style={{
      ...
      <p className="lg:w-[963px] mx-auto h-[139px] text-white text-[20px] text-center font-[700] leading-[27px]">
      ...
      <div className="flex flex-wrap items-center justify-center gap-[24px]">
        {certificates.map((data, id) => (
          <div
            key={id}
            className="w-[320px] sm:w-[468px] h-[589px] py-[16px] px-[26px] flex flex-col justify-center items-center text-white"
            style={{
              background:
      ...
      <button className="uppercase text-center text-[24px] font-[700] leading-[27px] underline text-white w-full pt-[34px] cursor-pointer">
        see more
      </button>
    </div>
  );
