        ...
        <div className="flex flex-col xl:flex-row gap-[33px] mt-12">
          ...
          <div className="w-[578px] h-[816px]  bg-[rgba(26,32,43,0.6)] text-white flex-col flex items-center justify-center">
            ...
            <div className="w-[322px] h-[309px]">
              {statementsOne.map((statementsOne, id) => (
                <div
                  key={id}
                  className="flex items-center gap-[15px] justify-start"
                >
                  <svg
                  ...
                  <p className="text-white text-[20px] font-[500] leading-[50px]">
                    {statementsOne}
                  </p>
                </div>
              ))}
            ...
            <div className="w-[378px] h-[66px] bg-[#272931] border-[1px] border-white flex items-center justify-center mt-[30px]">
              <h2 className="text-[#6b6b6b] text-center text-[28px] font-[600] leading-[28px] uppercase">
                remain an employee
              </h2>
            </div>
          </div>
          ...
          >
            ...
            <a
              ...
              className="mt-6 uppercase cursor-pointer sm:w-[509px] h-[66px] bg-[#00ff004f] border-[4px] border-white flex items-center justify-center"
            >
            ...
            <div className="flex items-center justify-center">
              ...
              <p className="underline text-[20px] leading-[50px] ">
